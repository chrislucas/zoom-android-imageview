...
import components.com.project.scalingimage.list.viewholder.ZoomableViewHolder;

/**
 * Created by r028367 on 09/08/2017.
 */

public class AdapterRecycleViewZoomableImageView extends RecyclerView.Adapter<ZoomableViewHolder> {
     ...
     * {@link #onBindViewHolder(ZoomableViewHolder, int)} (ViewHolder, int, List)}. Since it will be re-used to display
     ...
     * @see #onBindViewHolder(ZoomableViewHolder, int) (ViewHolder, int)
     */
    @Override
    public ZoomableViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(this.context).inflate(R.layout.layout_adapter_rc_imageview, parent, false);
        ZoomableViewHolder zoomableViewHolder = new ZoomableViewHolder(view);
        return zoomableViewHolder;
    }
     ...
     * <p>
     * Override {@link #onBindViewHolder(ZoomableViewHolder, int)} (ViewHolder, int, List)} instead if Adapter can
     ...
     */
    @Override
    public void onBindViewHolder(ZoomableViewHolder holder, int position) {
